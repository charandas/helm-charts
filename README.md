...
vm/victoria-metrics-agent  	0.1.2        	v1.35.1    	Victoria Metrics Agent - collects metrics from ...
vm/victoria-metrics-cluster	0.4.5        	1.35.1     	Victoria Metrics Cluster version - high-perform...
vm/victoria-metrics-single 	0.2.0        	1.35.1     	Victoria Metrics Single version - high-performa...
```
